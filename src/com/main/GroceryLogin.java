...
public class GroceryLogin extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (username.isEmpty()) {
            ...
            try {
                ...
                Logs logs = new Logs();
                logs.logger.log(Level.WARNING, "Grocery Store Login Quary Failed");
