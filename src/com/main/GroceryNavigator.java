...
import com.form.CustomerManagement;
import com.form.Grn;
import com.form.Home;
import com.form.PosAndInvoicing;
import com.form.GroceryProductManagement;
import com.form.GroceryStockManagement;
...
public class GroceryNavigator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/icon/9.png"))); // NOI18N
        buttonMenu2.setText("   POS and Invoicing");
        ...
        buttonMenu5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/icon/12.png"))); // NOI18N
        buttonMenu5.setText("   Customer Management");
        ...
        buttonMenu7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/icon/13.png"))); // NOI18N
        buttonMenu7.setText("   Goods Received Notes");
    ...
    private void buttonMenu4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenu4ActionPerformed
        showForm(new GroceryProductManagement());
    ...
    private void buttonMenu3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenu3ActionPerformed
        showForm(new GroceryStockManagement());
