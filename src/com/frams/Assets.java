...
public class Assets extends javax.swing.JPanel {
    ...
    private static HashMap<String, Integer> assetsMap = new HashMap<>();
    ...
    private void loadAssets() {
        try {
            ResultSet resultSet = MySql.execute("SELECT * FROM `assets`");
            Vector fv = new Vector();
            fv.add("SELECT");

            while (resultSet.next()) {
                fv.add(resultSet.getString("ass_name"));
                assetsMap.put(resultSet.getString("ass_name"), resultSet.getInt("ass_id"));
            }
    ...
    private void loadAssetsDetails() {
        try {
            ResultSet resultSet = MySql.execute("SELECT * FROM `assets_details` INNER JOIN `assets` ON `assets_details`.`sales_sa_id` = `assets`.`ass_id`");
    ...
    private void clearAssetsRegister() {
        jTextField3.setText("");
        jTextField1.setText("");
        loadAssets();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Select Assets");
        ...
        jLabel6.setText("Assets Register");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Expense", "Date", "Amout", "Depreciation Amount(% Per Year)"
            }
        ) {
        ...
        jLabel9.setText("Depreciation amount (% per year)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String assets = String.valueOf(jComboBox1.getSelectedItem());
        Double amount = Double.valueOf(jFormattedTextField1.getText());
        Double depreAmount = Double.valueOf(jFormattedTextField2.getText());
        ...
        if (assets == "SELECT") {
            ...
            int expenseId = assetsMap.get(assets);

            LocalDate d = LocalDate.now();
            DateTimeFormatter f = DateTimeFormatter.ofPattern("yyyy-MM-dd");
            String date = d.format(f);
            try {
                MySql.execute("INSERT INTO `assets_details` (`date`,`amount`,`depreciation_amount`,`sales_sa_id`) VALUES('" + date + "','" + amount + "','"+depreAmount+"','" + expenseId + "')");
                clearAssets();
                loadAssetsDetails();
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ResultSet resultSet = MySql.execute("SELECT * FROM `assets` WHERE `ass_name` = '" + name + "' OR `ass_code` = '" + code + "'");
                if (!resultSet.next()) {
                    MySql.execute("INSERT INTO `assets` (`ass_code`,`ass_name`)VALUES('" + code + "','" + name + "')");
                    loadAssets();
                    clearAssetsRegister();
                } else {
