...
public class BrandReg extends javax.swing.JPanel {
    ...
    private void loadBrand() {
        try {
            ...
            while (resultSet.next()) {
                ...
                fv.add(resultSet.getString("b_id"));
                fv.add(resultSet.getString("b_name"));
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Brand Register");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ResultSet resultSet = MySql.execute("SELECT * FROM `brand` WHERE `b_name` = '" + name + "'");
                if (!resultSet.next()) {
                    MySql.execute("INSERT INTO `brand` (`b_name`) VALUES('" + name + "')");
                    clear();
                } else {
                    JOptionPane.showMessageDialog(this, "Already have that brand", "Warning", JOptionPane.ERROR_MESSAGE);
                }
