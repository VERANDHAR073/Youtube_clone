...
public class GroceryProductManagement extends javax.swing.JPanel {
    ...
    public GroceryProductManagement() {
        initComponents();
        setOpaque(false);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(902, 557));
        ...
        jButton4.setBorder(jButton5.getBorder());
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(roundPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1253, Short.MAX_VALUE)
        );
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        } else if (barcode.equals(" Enter Product Barcode Here to Search")) {
            JOptionPane.showMessageDialog(this, "Please Scan or Enter Barcode To Search", "Warning", JOptionPane.WARNING_MESSAGE);
        } else {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        } else if (title.equals(" Enter Product Title Here to Search")) {
            JOptionPane.showMessageDialog(this, "Please Enter Title To Search", "Warning", JOptionPane.WARNING_MESSAGE);
        } else {

            loadProduct("SELECT * FROM `product` "
                    + "INNER JOIN `category` ON `product`.`c_id` = `category`.`c_id`"
                    + "INNER JOIN `brand` ON `product`.`b_id` = `brand`.`b_id` WHERE `title` LIKE '%" + title + "%'");
